    ...
    if (
      ...
      newRow.innerHTML = `
          ...
          <td class="codigo-barras-cell">
              <input id="codigo-barras" type="text" writingsuggestions="true" class="codigo-barras-input" value="${
                detalle.CODIGO_BARRA || ""
              }" onchange="validarCodigoBarras(this)" autofocus ${disabled}>
          </td>
          <td class="codigo-barras-cell2">
              <input id="cant-pedida" type="text" writingsuggestions="true" class="codigo-barras-input" value="${
                detalle.CANTIDAD_VERIFICADA || ""
...
function verificacion() {
  ...
  resultadoArray.forEach((resultado) => {
    const pedido = TrasladoList.find(
      (pedido) =>
